...
HD_PWD='C:/Users/fumi/Zybo/practice_VGA/practice_VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gradation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gradation.tcl -notrace
