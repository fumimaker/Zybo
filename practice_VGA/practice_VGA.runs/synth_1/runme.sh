...
HD_PWD='C:/Users/fumi/Zybo/practice_VGA/practice_VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gradation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gradation.tcl
