...
HD_PWD='C:/Users/fumi/Zybo/practice_3to8/practice_3to8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log threeToEight.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source threeToEight.tcl
