...
HD_PWD='C:/Users/fumi/Zybo/practice_3to8/practice_3to8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log threeToEight.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source threeToEight.tcl -notrace
