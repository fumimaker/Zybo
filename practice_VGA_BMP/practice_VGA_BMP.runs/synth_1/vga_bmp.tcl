...
synth_design -top vga_bmp -part xc7z010clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef vga_bmp.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file vga_bmp_utilization_synth.rpt -pb vga_bmp_utilization_synth.pb"
