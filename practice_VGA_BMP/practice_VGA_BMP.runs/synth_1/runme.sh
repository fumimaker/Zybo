...
HD_PWD='C:/Users/ivr/Documents/GitHub/Zybo/practice_VGA_BMP/practice_VGA_BMP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_bmp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_bmp.tcl
