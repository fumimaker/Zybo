...
HD_PWD='C:/Users/ivr/Documents/GitHub/Zybo/practice_VGA_BMP/practice_VGA_BMP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_bmp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_bmp.tcl -notrace
