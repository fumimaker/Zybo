...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  connect_bd_intf_net -intf_net display_0_M_AXI [get_bd_intf_pins axi_mem_intercon/S02_AXI] [get_bd_intf_pins display_0/M_AXI]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins display_0/DISPON]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins display_0/DISPADDR]
  connect_bd_net -net axi_gpio_1_gpio2_io_o [get_bd_pins axi_gpio_1/gpio2_io_o] [get_bd_pins display_0/CLRVBLNK]
  ...
  connect_bd_net -net display_0_VBLANK [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins display_0/VBLANK]
  connect_bd_net -net display_0_VGA_B [get_bd_ports VGA_B] [get_bd_pins display_0/VGA_B]
  connect_bd_net -net display_0_VGA_G [get_bd_ports VGA_G] [get_bd_pins display_0/VGA_G]
  connect_bd_net -net display_0_VGA_HS [get_bd_ports VGA_HS] [get_bd_pins display_0/VGA_HS]
  connect_bd_net -net display_0_VGA_R [get_bd_ports VGA_R] [get_bd_pins display_0/VGA_R]
  connect_bd_net -net display_0_VGA_VS [get_bd_ports VGA_VS] [get_bd_pins display_0/VGA_VS]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_0_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins display_0/ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net reset_1 [get_bd_ports RST] [get_bd_pins clk_wiz_0/reset] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins display_0/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x10000000 -offset 0x80000000 [get_bd_addr_spaces display_0/M_AXI] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
...
#  -string -flagsOSRD
preplace port RXD -pg 1 -y 1080 -defaultsOSRD
preplace port ddr3_sdram -pg 1 -y 60 -defaultsOSRD
preplace port VGA_VS -pg 1 -y 580 -defaultsOSRD
preplace port RST -pg 1 -y 760 -defaultsOSRD
preplace port CLK -pg 1 -y 1010 -defaultsOSRD
preplace port VGA_HS -pg 1 -y 560 -defaultsOSRD
preplace port TXD -pg 1 -y 950 -defaultsOSRD
preplace portBus VGA_B -pg 1 -y 540 -defaultsOSRD
preplace portBus VGA_R -pg 1 -y 500 -defaultsOSRD
preplace portBus LED -pg 1 -y 1080 -defaultsOSRD
preplace portBus VGA_G -pg 1 -y 520 -defaultsOSRD
preplace inst rst_mig_7series_0_83M -pg 1 -lvl 3 -y 100 -defaultsOSRD
preplace inst rst_clk_wiz_0_100M -pg 1 -lvl 2 -y 780 -defaultsOSRD
preplace inst mig_7series_0 -pg 1 -lvl 6 -y 100 -defaultsOSRD
preplace inst microblaze_0_axi_periph -pg 1 -lvl 5 -y 730 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 6 -y 1080 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 6 -y 340 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 6 -y 770 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 3 -y 630 -defaultsOSRD
preplace inst microblaze_0 -pg 1 -lvl 4 -y 630 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 6 -y 940 -defaultsOSRD
preplace inst display_0 -pg 1 -lvl 6 -y 560 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -y 1000 -defaultsOSRD
preplace inst microblaze_0_local_memory -pg 1 -lvl 5 -y 960 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -y 390 -defaultsOSRD
preplace netloc mig_7series_0_mmcm_locked 1 2 5 520 200 NJ 200 NJ 200 NJ 200 1990
preplace netloc display_0_VGA_R 1 6 1 NJ
preplace netloc rst_clk_wiz_0_100M_bus_struct_reset 1 2 3 NJ 760 NJ 760 1280
preplace netloc clk_wiz_0_locked 1 1 1 190
preplace netloc mig_7series_0_DDR3 1 6 1 NJ
preplace netloc display_0_VGA_G 1 6 1 NJ
preplace netloc microblaze_0_Clk 1 1 5 180 870 NJ 870 830 830 1320 1050 1710
preplace netloc rst_mig_7series_0_83M_peripheral_aresetn 1 3 3 NJ 140 1360 140 NJ
preplace netloc RXD_1 1 0 7 NJ 1080 NJ 1080 NJ 1080 NJ 1080 NJ 1080 NJ 1020 1990
preplace netloc microblaze_0_ilmb_1 1 4 1 1290
preplace netloc microblaze_0_axi_periph_M00_AXI 1 5 1 1680
preplace netloc microblaze_0_M_AXI_DP 1 4 1 N
preplace netloc microblaze_0_M_AXI_DC 1 4 1 1280
preplace netloc axi_mem_intercon_M00_AXI 1 5 1 1650
preplace netloc display_0_FIFO_UNDER 1 5 2 1750 860 2010
preplace netloc sys_clock_1 1 0 1 NJ
preplace netloc mig_7series_0_ui_clk 1 2 5 510 190 NJ 190 1350 190 NJ 190 2020
preplace netloc axi_uartlite_0_tx 1 6 1 NJ
preplace netloc xlconcat_0_dout 1 6 1 NJ
preplace netloc display_0_VBLANK 1 6 1 2000
preplace netloc axi_gpio_0_gpio_io_o 1 5 2 1740 420 2000
preplace netloc display_0_VGA_VS 1 6 1 NJ
preplace netloc microblaze_0_axi_periph_M01_AXI 1 5 1 1670
preplace netloc microblaze_0_M_AXI_IC 1 4 1 1300
preplace netloc rst_clk_wiz_0_100M_mb_reset 1 2 2 520 700 NJ
preplace netloc mig_7series_0_ui_clk_sync_rst 1 2 5 500 10 NJ 10 NJ 10 NJ 10 2020
preplace netloc clk_wiz_0_clk_out2 1 1 5 NJ 1010 NJ 1010 NJ 1010 NJ 1060 1690
preplace netloc microblaze_0_axi_periph_M02_AXI 1 5 1 N
preplace netloc display_0_M_AXI 1 4 3 1370 210 NJ 210 2020
preplace netloc microblaze_0_dlmb_1 1 4 1 1310
preplace netloc axi_gpio_1_gpio2_io_o 1 5 2 1750 690 1990
preplace netloc axi_gpio_0_gpio2_io_o 1 5 2 1750 430 1990
preplace netloc clk_wiz_0_clk_out3 1 1 5 NJ 1030 NJ 1030 NJ 1030 NJ 1070 1700
preplace netloc microblaze_0_debug 1 3 1 N
preplace netloc display_0_FIFO_OVER 1 5 2 1740 850 2020
preplace netloc display_0_VGA_B 1 6 1 NJ
preplace netloc display_0_VGA_HS 1 6 1 NJ
preplace netloc rst_clk_wiz_0_100M_peripheral_aresetn 1 2 4 NJ 820 NJ 820 1340 1040 1720
preplace netloc rst_clk_wiz_0_100M_interconnect_aresetn 1 2 3 500 530 NJ 530 1370
preplace netloc reset_1 1 0 6 20 760 190 540 NJ 540 NJ 540 NJ 570 NJ
preplace netloc mdm_1_debug_sys_rst 1 1 3 200 690 NJ 690 820
levelinfo -pg 1 0 100 350 670 1060 1510 1870 2040 -top 0 -bot 1140
",
}
